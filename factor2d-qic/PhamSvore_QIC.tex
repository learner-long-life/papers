...
\end{displaymath}
\centerline{}
\fcaption{Constant-depth circuits based on \protect{\cite{Broadbent2007,Browne2009}} for (a) teleportation \protect{\cite{Rosenbaum2012}} and (b) fanout \protect{\cite{Harrow2012}}.}
\label{fig:cd}
...
part (b) of Figure \ref{fig:cd} for the case of fanning out a given single-qubit state $\ket{\psi}$ to
four qubits.
