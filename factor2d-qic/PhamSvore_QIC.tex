...
\emph{module size} (number of qubits teleported between modules),
\emph{module depth} (depth of consecutive teleportations between modules),
\emph{module width} (number of modules).
...
%%%% TODO
%%%% Insert figure of qcircuit for Bell basis measurement
