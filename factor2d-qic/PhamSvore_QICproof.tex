...
\copyrightheading{13}{11\&12}{2013}{0937--0962}
...
\vspace*{0.225truein}
\publisher{October 11, 2012}{March 29, 2013}
...
\textsc{2D CCNTCM}, in order to analyze our current circuit.
...
which is a self-contained \textsc{2D CCNTC} lattice.
%This should not be
...
%\begin{definition}
\par
{\noindent\bf Definition~2} {\it A \textsc{2D CCNTCM} architecture consists of
...
circuit resources and not their module resources.
For the modular multiplier in
Section \ref{sec:csa-mod-mult} and the modular exponentiator in
Section \ref{sec:modexp}, we give both circuit and module resources.
...
our construction and upper bound the
resources required.
